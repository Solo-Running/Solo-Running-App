...
typealias User = SoloSchemaV2.User
typealias Run = SoloSchemaV2.Run
typealias Location = SoloSchemaV2.Location
typealias MTPlacemark = SoloSchemaV2.MTPlacemark
typealias Pace = SoloSchemaV2.Pace
...
enum SoloSchemaMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [SoloSchemaV1.self, SoloSchemaV2.self]
    }
